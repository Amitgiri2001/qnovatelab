  ...
  return (
    <div className='home'>
      ...
      <div className='courses' style={{ marginTop: "50px" }} >
        <h1 className='text-center' style={{ color: "#7800af",marginBottom:"2%" }}>Our Programs</h1>
        <div class="row">
          <div class="col-md-3">
      ...
      <div className='why-stem text-center'>
        ...
        <div className='row'>
          ...
          <div className='col-sm-6 stem-col'>
            ...
            <a href='/registration'>
            <button className='btn'><i class="fa-solid fa-pen-to-square"></i>Register Now</button></a>
          </div>
        </div>
      ...
      <div className='row'>
        ...
        <div className='col-md-6 registernow' style={{ marginTop: "40px" }}>
          ...
          <a href="/registration" target="_blank" ><i class="fa-solid fa-rocket"></i> Register Now</a>
        </div>
      </div>
      <Footer />
    </div>
